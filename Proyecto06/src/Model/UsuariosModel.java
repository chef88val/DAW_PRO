...
public class UsuariosModel {
	...
	/*Definimos la sentencia para insertar los nombres de usuarios
	private final static String USUARIO_INS = "insert into usuarios values";
	INSERT INTO `GamesDB`.`usuarios` (`nick`, `pass`, `nombre`) 
	VALUES ('chef88val', 'hola', 'javier');
